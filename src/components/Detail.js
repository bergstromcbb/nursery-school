...
let Detail = (props) => {
	...
	return (
		<div className="container text-center">
			<div className="detail-location-header">{props.forecast.city.name + ', ' + props.forecast.city.country}</div>			<img style={{ width: "100px" }} src={`http://openweathermap.org/img/w/${icon}.png`} />
